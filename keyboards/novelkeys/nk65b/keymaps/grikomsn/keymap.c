...
[1] = LAYOUT_65_ansi(
    ...
    KC_MUTE,    KC_VOLD,    KC_VOLU,                            KC_TRNS,                                        KC_TRNS,    MO(2),      KC_TRNS,    KC_BRID,    KC_VOLD,    KC_BRIU),
...
const uint16_t PROGMEM tab_escape_combo[] = {KC_TAB, KC_ESC, COMBO_END};
const uint16_t PROGMEM lshift_tab_escape_combo[] = {KC_LSFT, KC_TAB, KC_ESC, COMBO_END};
combo_t key_combos[] = {
    COMBO(tab_escape_combo, KC_GRV),
    COMBO(lshift_tab_escape_combo, KC_TILD),
};
