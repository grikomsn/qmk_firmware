...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN1] = LAYOUT_ansi_67(
        ...
        KC_TRNS,          RGB_TOG, RGB_MOD, RGB_HUD, RGB_HUI, RGB_SAD, RGB_SAI, RGB_VAD, RGB_VAI, RGB_SPD, RGB_SPI,             KC_TRNS, KC_VOLU,
        KC_TRNS, KC_TRNS, KC_TRNS,                            KC_TRNS,                            KC_TRNS, MO(_FN2),  KC_TRNS,   KC_BRID, KC_VOLD, KC_BRIU),
    ...
    [_FN2] = LAYOUT_ansi_67(
        ...
        KC_TRNS, KC_TRNS, KC_TRNS,                            KC_TRNS,                            MO(_FN3), KC_TRNS,  KC_TRNS,   KC_TRNS, KC_TRNS, KC_TRNS),
...
const key_override_t left_three_mods_vold_as_brid = ko_make_basic(MOD_BIT_LCTRL | MOD_BIT_LALT | MOD_BIT_LGUI, KC_VOLD, KC_BRID);
const key_override_t left_three_mods_volu_as_briu = ko_make_basic(MOD_BIT_LCTRL | MOD_BIT_LALT | MOD_BIT_LGUI, KC_VOLU, KC_BRIU);

const key_override_t *key_overrides[] = {
    &lctl_bspc_as_del_override,
    &rgui_gesc_as_is_override,
    &rshift_gesc_as_is_override,
    &left_three_mods_vold_as_brid,
    &left_three_mods_volu_as_briu,
};
